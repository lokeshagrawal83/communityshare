...
module.controller(
	'MatchesController',
	[ '$scope', 'Session', 'Search', '$location', 'labelMapping', 'makeDialog', 'startConversation', 'Messages', '$modal',
		function( $scope, Session, Search, $location, labelMapping, makeDialog, startConversation, Messages, $modal ) {
...
module.controller(
	...
	[ '$scope', '$location', '$q', 'User', 'Session', '$routeParams', 'parseyyyyMMdd', 'startConversation',
		function( $scope, $location, $q, User, Session, $routeParams, parseyyyyMMdd, startConversation ) {
			$scope.Session = Session;
			$scope.startConversation = startConversation;
